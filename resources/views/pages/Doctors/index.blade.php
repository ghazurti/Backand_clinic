        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    You can manage all Dokter, such as editing, deleting and more.
                </p>
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($dokters as $dokter)
                                            <tr>
                                                ...
                                                <td>{{ $dokter->dokter_name }}
                                                </td>
                                                <td>
                                                    @if ($dokter->dokter_photo)
                                                        <img src="{{ asset($dokter->dokter_photo) }}"
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <form action="{{ route('Doctors.destroy', $dokter->id) }}"
